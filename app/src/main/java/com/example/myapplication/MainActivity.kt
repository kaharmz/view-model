...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        activityMainBinding.btnCalculate.setOnClickListener {
            ...
            when {
                width.isEmpty() -> {
                    activityMainBinding.edtWidth.error = "Field cannot be empty"
                }

                height.isEmpty() -> {
                    activityMainBinding.edtHeight.error = "Field cannot be empty"
                }

                length.isEmpty() -> {
                    activityMainBinding.edtLength.error = "Field cannot be empty"
                }
